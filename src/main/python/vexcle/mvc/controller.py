...
from vexcle.paths import sanitize
...
class Controller(object):
    ...
    def setup_view(self):
        self.view.setWindowTitle(f"{self._settings['app_name']} - "
                                 f"{self._settings['version']}")
        self.create_signals()
    ...
    def set_background_image(self):
        bg_image = sanitize(self._context.get_resource("drag-and-drop.png"))
